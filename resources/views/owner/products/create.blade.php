                    ...
                    <form method="post" action="{{ route('owner.products.store') }}">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-full flex justify-around mt-4">
                                ...
                                <button type="submit" class="text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Store</button>
                            </div>
                            <div class="p-2 w-1/2 mx-auto">
                                <div class="relative flex justify-around">
                                    <div><input type="radio" name="is_selling" value="1" class="mr-2">On Sale</div>
                                    <div><input type="radio" name="is_selling" value="0" class="mr-2">Not On Sale</div>
                                </div>
                            </div>
                        </div>
